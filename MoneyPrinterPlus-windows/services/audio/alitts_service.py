...
class AliAudioService(AudioService):
    ...
    def __init__(self):
        ...
        self.error_occurred = False  # Initialize error flag
    ...
    def on_error(self, message, *args):
        ...
        self.error_occurred = True  # Set flag when error occurs
    ...
    def save_with_ssml(self, text, file_name, voice, rate="0"):
        ...
        # If error occurred, remove the empty file
        if self.error_occurred and os.path.exists(file_name):
            os.remove(file_name)
            print(f"Removed empty audio file due to TTS error: {file_name}")
